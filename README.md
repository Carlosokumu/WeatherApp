# WeatherApp
Writing Weather App  Using Android Architecture Components in 100% Kotlin.The final apk can be downloaded from here [APK](https://github.com/Carlosokumu/TopUpMama/blob/master/app/release/topup.apk)
